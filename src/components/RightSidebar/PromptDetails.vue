<template>
  <div v-if="prompt" class="space-y-4">
    <div>
      <label for="prompt-name" class="block text-sm font-medium text-gray-700">名称</label>
      <input
        id="prompt-name"
        type="text"
        :value="prompt.name"
    ...
    <div>
      <label for="prompt-id" class="block text-sm font-medium text-gray-700">标识符</label>
      <input
        id="prompt-id"
        type="text"
    ...
    <div>
      <label for="prompt-content" class="block text-sm font-medium text-gray-700">内容</label>
      <textarea
        id="prompt-content"
